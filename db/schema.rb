...
ActiveRecord::Schema[7.0].define(version: 2023_06_03_075034) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.bigint "user_ref_id", null: false
    t.index ["user_ref_id"], name: "index_categories_on_user_ref_id"
  end
  ...
  add_foreign_key "categories", "users", column: "user_ref_id"
